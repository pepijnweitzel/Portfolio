...
knowledge2 = And(
    ...
    Or(Not(AKnave), Or(Not(And(AKnight, BKnight)), Not(And(AKnave, BKnave)))),
    Or(Not(BKnight), And(Or(AKnight, BKnight), Or(AKnave, BKnave))),
    Or(Not(BKnave), Or(And(AKnight, BKnight), And(AKnave, BKnave))),
    Or(Not(AKnave), And(Not(And(AKnight, BKnight)), Not(And(AKnave, BKnave))))
)
